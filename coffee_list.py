...
if logged_in == True and profile_nav == "Show diagrams":
    ...
    if correlation:
       ...
       fig5.update_layout(title_font_size=24, showlegend=False, hover_data=["size"], xaxis=dict(tickmode = 'array', tickvals = tickval_num, ticktext = names), yaxis=dict(tickmode = 'array', tickvals = tickval_num, ticktext = names))

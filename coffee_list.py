    ...
    if correlation:
        ...
        for i in range(len(names)):
            ...
            for j in range(len(names)):
               ...
               temp_abs.append(i+1)
               temp_rel.append(i+1)
               temp_abs.append(corr_abs_raw[len(names)-i-1][j])      #calculates absolute correlation
               temp_rel.append(corr_rel_raw[len(names)-i-1][j])      #calculates relative correlation
